    ...
    >
      {dot.imageUrl ? (
        ...
        <img
          src={dot.imageUrl}
          alt=""
          className="w-full h-full rounded-2xl object-cover shadow-xl ring-2 ring-white"
        />
      ) : (
        <div className="w-full h-full rounded-2xl bg-[#85241F] shadow-xl ring-2 ring-white flex items-center justify-center text-lg">
          🛍️
        </div>
      )}
    </div>
