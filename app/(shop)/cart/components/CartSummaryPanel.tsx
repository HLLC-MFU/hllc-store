  ...
  return (
    <CheckoutFooter
      ...
      leftSlot={
        ...
        >
          <div className={`flex h-6 w-6 items-center justify-center rounded-lg border-2 transition-colors ${allSelected ? "border-[#85241F] bg-[#85241F]" : "border-gray-300 bg-white"}`}>
